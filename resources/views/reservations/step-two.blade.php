                    ...
                    <div class="col-md-12 bg-white">
                        ...
                        <div class="col-md-6 col-sm-6 wow fadeInUp bg-white" data-wow-delay="0.6s">
                            <h2 class="mb-4 text-xl font-bold text-blue-600">Make Reservation</h2>
                                ...
                                <div class="w-full bg-gray-200 rounded-full">
                                    <div
                                        class="w-100 p-1 text-xl font-medium leading-none text-center text-blue-100 bg-blue-600 rounded-full">
                                        Step2</div>
                                </div>
                                ...
                                <form method="POST" action="{{ route('reservations.store.step.two') }}">
                                    @csrf
                                    <div class="sm:col-span-6 pt-5">
                                        <label for="status" class="block text-xl font-medium text-gray-700">Table</label>
                                        <div class="mt-1">
                                            <select id="table_id" name="table_id"
                                                class="form-multiselect block w-full mt-1">
                                                @foreach ($tables as $table)
                                    ...
                                    <div class="mt-6 p-4 flex justify-between">
                                        <a href="{{ route('reservations.step.one') }}"
                                            class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white btn-lg">Previous</a>
                                        <button type="submit"
                                            class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white btn-lg">Make
                                            Reservation</button>
                                    </div>
                                </form>
                        </div>
